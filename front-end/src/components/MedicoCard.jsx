    ...
    <div className="bg-gray-800 rounded-3xl shadow-xl p-8 sm:p-10 hover:shadow-cyan-500/10 hover:shadow-2xl transition-all duration-300 border border-gray-700 flex flex-col justify-between h-full group">
      <div className="space-y-6 mb-8 text-center flex-1 flex flex-col items-center justify-center">
        <div className="w-full border-b border-gray-700/60 pb-6 shrink-0">
          ...
          <p className="text-cyan-400 text-2xl sm:text-3xl font-extrabold group-hover:text-cyan-300 transition-colors">{medico.nome}</p>
        </div>
        ...
        <div className="w-full flex-1 flex flex-col justify-center gap-4">
          <div className="bg-gray-900/40 rounded-2xl p-4 transform transition-all group-hover:scale-[1.02]">
            <p className="text-gray-500 text-xs uppercase tracking-widest font-bold mb-1">CPF</p>
            <p className="text-gray-200 text-lg tracking-wider font-medium">{medico.cpf}</p>
          </div>

          <div className="bg-gray-900/40 rounded-2xl p-4 transform transition-all group-hover:scale-[1.02]">
            <p className="text-gray-500 text-xs uppercase tracking-widest font-bold mb-1">CRM</p>
            <p className="text-indigo-400 text-lg font-mono font-bold tracking-wider">{medico.crm}</p>
          </div>
          
          <div className="bg-gray-900/40 rounded-2xl p-4 transform transition-all group-hover:scale-[1.02]">
            <p className="text-gray-500 text-xs uppercase tracking-widest font-bold mb-1">Data Nasc.</p>
            <p className="text-gray-200 text-lg font-medium">{medico.dataNascimento}</p>
          </div>
        ...
        <div className="pt-6 shrink-0 w-full flex flex-col gap-2">
          <p className="text-gray-600 text-xs font-medium">Criado em: <span className="text-gray-400">{medico.createdAt}</span></p>
          <p className="text-gray-600 text-xs font-medium">Atualizado em: <span className="text-gray-400">{medico.updatedAt}</span></p>
        </div>
      </div>
